...
<tr><td colspan="2"><h2>{l}Links{/l}</h2></td></tr>
  <tr>
  	<td class="label"><span class='req'>*</span>{l}Check Links{/l}:</td>
  	<td class="smallDesc">
  ...
  <tr>
  	<td class="label">{l}Set inactive if broken{/l}:</td>
  	<td class="smallDesc">
  		{html_checkboxes name="IL" options=$stat_inactive selected=$IL separator=" "}
  	</td>
  </tr>
  <tr>
  	<td class="label">{l}Set active if valid{/l}:</td>
  	<td class="smallDesc">
  		{html_checkboxes name="AL" options=$stat_active selected=$AL separator=" "}
  	</td>
  </tr>

<tr><td colspan="2"><h2>{l}Reciprocal Links{/l}</h2></td></tr>
  <tr>
  	<td class="label"><span class='req'>*</span>{l}Check Reciprocal Links{/l}:</td>
  	<td class="smallDesc">
  		<input type="checkbox" name="VALIDATE_RECPR" value="1" {if $VALIDATE_RECPR}checked="1"{/if} />
  	</td>
  </tr>
  <tr>
  	<td class="label">{l}Set inactive if broken{/l}:<br />{l}(only if recpr. required){/l}</td>
  	<td class="smallDesc">
  		{html_checkboxes name="IR" options=$stat_inactive selected=$IR separator=" "}
  	</td>
  </tr>
  <tr>
  	<td class="label">{l}Set active if valid{/l}:<br />{l}(only if link not broken){/l}</td>
  	<td class="smallDesc">
