{capture name='field_required'}<span class="err">{l}This field is required{/l}</span>{/capture}
{capture name='invalid_username'}<span class="err">{l}Invalid username. Please see the field help for more details.{/l}</span>{/capture}
{capture name='invalid_email'}<span class="err">{l}Invalid email address format{/l}</span>{/capture}
{capture name='invalid_password'}<span class="err">{l}Invalid password. Please see the field help for more details.{/l}</span>{/capture}
{capture name='password_not_match'}<span class="err">{l}Password confirmation does not match. Please type again.{/l}</span>{/capture}
...
{if $message eq 'INSTALL_DB_CREATED'}
	<p><image src="images/info_22.gif"/>{l}Database was created succesfully.{/l}</p>
{elseif $message eq 'INSTALL_DB_UPDATED'}
	<p><image src="images/info_22.gif"/>{l}Database was updated succesfully.{/l}</p>
{elseif $message eq 'ADMIN_CREATED'}
	<p><image src="images/info_22.gif"/>{l}Administrative user was created/updated succesfully.{/l}</p>
{/if}
</div>
{/strip}{/capture}
{/if}